    ...
    <div className="h-full bg-gradient-to-b from-sky-800 via-amber-900 to-stone-900 flex flex-col justify-center items-center text-center">
      <div className="w-full max-w-6xl px-8">
        <img 
          ...
          className="w-full max-w-4xl h-80 object-contain rounded-lg shadow-2xl mb-6 opacity-0 animate-scaleIn border-2 border-sky-700/30 mx-auto"
        />
        <h2 className="text-5xl font-bold text-sky-100 mb-4 opacity-0 animate-fadeInDown animation-delay-200 drop-shadow-lg">Within a Generation</h2>
        <div className="bg-gradient-to-r from-transparent via-amber-800/30 to-transparent p-4 rounded-lg max-w-4xl mx-auto">
